    ...
    <div className="generalidades" id="section-1">
      ...
      <div className="generalidades_main-wrapper">
        <div className="generalidades_subsection-wrapper">
          {currentMediaPlaying &&
          currentMediaPlaying.sectionId == 1 &&
          currentMediaPlaying.mediaType == 2 ? (
            ...
            <>
              ...
              <div className="generalidades_subsection-media">
                {data.map((media) => {
                  if (media.subsection == 1 && media.section === "1") {
                    return (
                      <Card
                        key={media.id}
        ...
        <div className="generalidades_subsection-wrapper" id="section-2">
          {currentMediaPlaying &&
          currentMediaPlaying.sectionId == 2 &&
          currentMediaPlaying.mediaType == 1 ? (
            <Infografia />
          ) : (
            <>
              <SubsectionBanner
                ...
                color="transparent"
                classNameDiv="desktop__pr-5"
              />

              <div
                className="generalidades_subsection-media desktop__pr-5"
              >
                {data.map((media) => {
                  if (media.subsection == 2) {
                    return (
                      <Card
                        ...
                        customClass={`generalidades__double-row unique-card sections`}
                        setDisplayMedia={handleDisplayMedia}
                        isAvailable={media.available}
                      />
                    );
